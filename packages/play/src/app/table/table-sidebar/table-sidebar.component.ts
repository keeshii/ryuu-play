import { Component, Input, EventEmitter, Output, OnChanges, OnDestroy, inject, DestroyRef } from '@angular/core';
import { Player, State, ReplayPlayer, PlayerStats } from '@ptcg/common';
