...
export enum GameCardMessage {
  ...
  REVEAL_OPPONENT_HAND_CARD = 'REVEAL_OPPONENT_HAND_CARD',
  REVEAL_OPPONENT_PRIZE_CARD = 'REVEAL_OPPONENT_PRIZE_CARD',
  REVEAL_OPPONENT_TOP_DECK_CARD = 'REVEAL_OPPONENT_TOP_DECK_CARD',
  REVEAL_PRIZE_CARD = 'REVEAL_PRIZE_CARD',
  REVEAL_TOP_DECK_CARD = 'REVEAL_TOP_DECK_CARD',
  SPECIAL_CONDITION_ASLEEP = 'SPECIAL_CONDITION_ASLEEP',
  SPECIAL_CONDITION_BURNED = 'SPECIAL_CONDITION_BURNED',
  SPECIAL_CONDITION_CONFUSED = 'SPECIAL_CONDITION_CONFUSED',
  SPECIAL_CONDITION_PARALYZED = 'SPECIAL_CONDITION_PARALYZED',
  SPECIAL_CONDITION_POISONED = 'SPECIAL_CONDITION_POISONED',
  TYPE_DARK = 'TYPE_DARK',
  ...
  WANT_TO_DISCARD_POKEMON = 'WANT_TO_DISCARD_POKEMON',
...
export enum GameLog {
  ...
  LOG_PLAYER_CHANGES_TYPE_TO = 'LOG_PLAYER_CHANGES_TYPE_TO', // { name, message }
  LOG_PLAYER_COPIES_ATTACK = 'LOG_PLAYER_COPIES_ATTACK', // { name, attack }
  LOG_PLAYER_DISABLED_ATTACK = 'LOG_PLAYER_DISABLED_ATTACK', // { name, attack }
